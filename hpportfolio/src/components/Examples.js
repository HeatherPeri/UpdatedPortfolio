...
<div>
    ...
    <Row>
        ...
        <CardBody className="text-center">
          ...
          <CardSubtitle>Full application created in a team </CardSubtitle>
        ...
        <CardBody className="text-center">
          ...
          <CardSubtitle>Front end responsiveness</CardSubtitle>
          ...
          <Button href="https://github.com/HeatherPeri/Animate">Github</Button>
        </CardBody>
        </Card>
        </Col>
    </Row>
<br></br>
    <Row>
        ...
        <CardBody className="text-center">
          ...
          <Button href="https://github.com/HeatherPeri/bamazon">Github</Button>
